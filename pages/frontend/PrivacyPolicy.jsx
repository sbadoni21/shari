...
const PrivacyPolicy = () => {
  return (
    <div className=" pt-20 pl-6 pr-6  md:p-20 bg-gradient-to-t from-black from-10% to-[#E499B8] text-white">
...
You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</div>
      ...
      <div>
        ...
        through a mobile device. Information Collected while Using the
        Application While using Our Application, in order to provide features of
        ...
        Device settings. Use of Your Personal Data The Company may use Personal
